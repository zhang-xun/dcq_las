...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/home/zhangxun/code/dcq_las/env/bin',
 'BINLIBDEST': '/home/zhangxun/code/dcq_las/env/lib/python3.5',
 'BLDLIBRARY': '-L. -lpython3.5m',
 'BLDSHARED': 'gcc -pthread -shared '
              '-L/home/zhangxun/code/dcq_las/env/lib '
              '-Wl,-rpath=/home/zhangxun/code/dcq_las/env/lib,--no-as-needed',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CONFIGURE_CPPFLAGS': '-I/home/zhangxun/code/dcq_las/env/include',
 'CONFIGURE_LDFLAGS': '-L/home/zhangxun/code/dcq_las/env/lib '
                      '-Wl,-rpath=/home/zhangxun/code/dcq_las/env/lib,--no-as-needed',
 'CONFIG_ARGS': "'--enable-shared' '--enable-ipv6' '--with-ensurepip=no' "
                "'--prefix=/home/zhangxun/code/dcq_las/env' "
                "'--with-tcltk-includes=-I/home/zhangxun/code/dcq_las/env/include' "
                "'--with-tcltk-libs=-L/home/zhangxun/code/dcq_las/env/lib "
                "-ltcl8.5 -ltk8.5' "
                "'CPPFLAGS=-I/home/zhangxun/code/dcq_las/env/include' "
                "'LDFLAGS=-L/home/zhangxun/code/dcq_las/env/lib "
                "-Wl,-rpath=/home/zhangxun/code/dcq_las/env/lib,--no-as-needed' "
                "'PKG_CONFIG_PATH=/home/zhangxun/code/dcq_las/env/lib/pkgconfig'",
 'CONFINCLUDEDIR': '/home/zhangxun/code/dcq_las/env/include',
 'CONFINCLUDEPY': '/home/zhangxun/code/dcq_las/env/include/python3.5m',
 'COREPYTHONPATH': ':plat-linux',
 'COVERAGE_INFO': '/home/ilan/minonda/conda-bld/python-3.5_1488822992936/work/Python-3.5.3/coverage.info',
 'COVERAGE_REPORT': '/home/ilan/minonda/conda-bld/python-3.5_1488822992936/work/Python-3.5.3/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-I. -I./Include '
             '-I/home/zhangxun/code/dcq_las/env/include',
 'CXX': 'g++ -pthread',
 'DESTDIRS': '/home/zhangxun/code/dcq_las/env '
             '/home/zhangxun/code/dcq_las/env/lib '
             '/home/zhangxun/code/dcq_las/env/lib/python3.5 '
             '/home/zhangxun/code/dcq_las/env/lib/python3.5/lib-dynload',
 'DESTLIB': '/home/zhangxun/code/dcq_las/env/lib/python3.5',
 'DESTPATH': '',
 'DESTSHARED': '/home/zhangxun/code/dcq_las/env/lib/python3.5/lib-dynload',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/home/zhangxun/code/dcq_las/env/include '
                   '/home/zhangxun/code/dcq_las/env/include '
                   '/home/zhangxun/code/dcq_las/env/include/python3.5m '
                   '/home/zhangxun/code/dcq_las/env/include/python3.5m',
 'INCLUDEDIR': '/home/zhangxun/code/dcq_las/env/include',
 'INCLUDEPY': '/home/zhangxun/code/dcq_las/env/include/python3.5m',
 ...
 'LDVERSION': '3.5m',
 'LIBC': '',
 'LIBDEST': '/home/zhangxun/code/dcq_las/env/lib/python3.5',
 'LIBDIR': '/home/zhangxun/code/dcq_las/env/lib',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/home/zhangxun/code/dcq_las/env/lib/pkgconfig',
 'LIBPL': '/home/zhangxun/code/dcq_las/env/lib/python3.5/config-3.5m',
 ...
 'MACHDEPS': 'plat-linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/home/zhangxun/code/dcq_las/env/lib/python3.5',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': 'gcc -pthread',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/home/zhangxun/code/dcq_las/env/share/man',
 'MKDIR_P': '/bin/mkdir -p',
 'MODLIBS': '',
 ...
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-L/home/zhangxun/code/dcq_las/env/lib '
               '-Wl,-rpath=/home/zhangxun/code/dcq_las/env/lib,--no-as-needed',
 'Py_DEBUG': 0,
 'Py_ENABLE_SHARED': 1,
 'Py_HASH_ALGORITHM': 0,
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/home/ilan/minonda/conda-bld/python-3.5_1488822992936/work/Python-3.5.3',
 'SCRIPTDIR': '/home/zhangxun/code/dcq_las/env/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '',
 'SHELL': '/bin/sh',
 ...
 'TCLTK_INCLUDES': '-I/home/zhangxun/code/dcq_las/env/include',
 'TCLTK_LIBS': '-L/home/zhangxun/code/dcq_las/env/lib '
               '-ltcl8.5 -ltk8.5',
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/home/ilan/minonda/conda-bld/python-3.5_1488822992936/work/Python-3.5.3 '
               './python',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/home/ilan/minonda/conda-bld/python-3.5_1488822992936/work/Python-3.5.3 '
 ...
 'abs_builddir': '/home/ilan/minonda/conda-bld/python-3.5_1488822992936/work/Python-3.5.3',
 'abs_srcdir': '/home/ilan/minonda/conda-bld/python-3.5_1488822992936/work/Python-3.5.3',
 'datarootdir': '/home/zhangxun/code/dcq_las/env/share',
 'exec_prefix': '/home/zhangxun/code/dcq_las/env',
 'prefix': '/home/zhangxun/code/dcq_las/env',
 'srcdir': '.'}
